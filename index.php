...
$run_query = mysqli_query($conn, $show_query);

$get_value=  mysqli_fetch_array($run_query);
						...
						<div class="row">
							...
							<div class="col col-md-8">
								...
								<ul class="list-unstyled small">
									<li><i class="fa fa-home"></i> &nbsp Sitz der Gesellschaft: Monkey Cage GmbH Liebigstr. 4<br>
63743 Aschaffenburg<br>Fax +49 6021 445 2930</li>
									...
									<li><i class="fa fa-building-o"> </i> &nbsp Amtsgericht Aschaffenburg</li>
									...
									<li><i class="fa fa-briefcase"> </i>  &nbsp Finanzamt Aschaffenburg<a href="">
							...
							<div id="nav-main" class="collapse navbar-collapse mob-navbar-collapse-dark">
								...
								* Use class "nav-border-bottom" to enable menu links with bottom border (class "nav-pills" is required).
								...
								<!--	<li class="dropdown dropdown-menu-dark dropdown-hover">
									...
									<li><span class="nav-link-separator">/</span></li>
									<li><a class="mlc sm-scroll" href="#section-8">Social Media</a></li>
									<li><span class="nav-link-separator">/</span></li>
									<li><a class="mlc sm-scroll" href="#section-10">Anfahrt und Kontakt</a></li>
				...
				<div class="container">
						...
						<!-- Left column -->
							...
							* Use class "heading-uppercase" to enable uppercase letters.
							-->
							<div class="heading heading-lg heading-hover">
							<h2 class="heading-title text-white" >Social Media</h2>
                    ...
                    <div class="fb-page" data-href="https://www.facebook.com/MonkeyCage2016/" data-tabs="timeline" data-width="300" data-height="300" data-small-header="false"  data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/MonkeyCage1/" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/MonkeyCage1/">MonkeyCage</a></blockquote></div>
...
<section id="section-10" class="contact-section bg-dark angle-right-top bg-image-parallax" style="background-image: url(assets/img/misc/bg-1.jpg); padding: 80px 0px 80px 0px;">
