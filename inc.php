...
wir freuen uns euch, nachdem die Ger&#220chtek&#220che in der Aschaffenburger Boulderszene nun schon seit Wochen flei&#223ig gek&#214chelt hat, offiziell ein bisschen Input zur geplanten Boulderhalle geben zu k&#214nnen.</p>
							...
							<div class="col col-md-4">
								...
								<ul class="list-unstyled small">
									<li><i class="fa fa-home"></i> &nbsp Monkey Cage - GmbH. Liebigstr. 463743 Aschaffenburg, Germany</li>
									<li><i class="fa fa-phone"></i> &nbsp +49 152 53975442</li>
									<li><i class="fa fa-envelope-o"></i> <a href="mailto:support@mail.com">info@monkey-cage.de</a></li>
									<li><i class="fa fa-building-o"> </i> &nbsp Amtsgericht</li>
									<li><a href="#"> Aschaffenburg </a></li>
									<li><i class="fa fa-briefcase"> </i>  &nbsp Geschaftsfuhrung<a href="">
							...
							<div class="col col-md-4">
								...
								<h4 class="top-slidingbar-heading text-gray-2">Monkey-cage</h4>
								<hr class="hr-width-1 hr-double margin-top-15">
								...
								* Use class "gutter-1", "gutter-2", "gutter-3", "gutter-4" or "gutter-5" to add more space between items.
								-->
								<ul >
									<li><a  href="assets/img/vertical.png">  <img src="assets/img/vertical.png" alt="Monkey-Cage" width="300" height="200" >  </a></li>
				...
				* Use class "header-md", "header-lg" or "header-xlg" to change header size.
				...
				<div id="header" class="header-md fixed-top header-dark transparent">
					<div id="scrollspy" class="container header-container">
						...
						<a href="index.php" style="color: white; " ><h2>MonkeyCage</h2></a>
						</div>
						<!-- End logo -->
							...
							<div id="nav-main" class="collapse navbar-collapse mob-navbar-collapse-dark">
								...
								* Use class "nav-border-bottom" to enable menu links with bottom border (class "nav-pills" is required).
								...
								<!--	<li class="dropdown dropdown-menu-dark dropdown-hover">
									...
									<li><span class="nav-link-separator">/</span></li>
									<li><a class="mlc sm-scroll" href="#section-2">Dienstleistung</a></li>
									<li><span class="nav-link-separator">/</span></li>
									...
									<li><a class="mlc sm-scroll" href="">Essen und Trinken</a></li>
						...
						<div class="col-md-6">
							...
							* Use class "heading-uppercase" to enable uppercase letters.
							...
							<div class="heading heading-lg text-white heading-hover wow fadeIn" data-wow-delay="0.2s">
								...
								<h2 class="heading-title">Willkommen bei Monkey- Cage</h2>
								...
								* Use class "hr-dotted", "hr-dashed" or "hr-double" to shange divider style.
								...
								<p class="heading-tescription lead text-gray-2" style="text-align: justify;" >
									Hallo Sportsfreunde,wir freuen uns euch, nachdem die Ger&#220chtek&#220che in der Aschaffenburger Boulderszene nun schon seit Wochen flei&#223ig gek&#214chelt hat, offiziell ein bisschen Input zur geplanten Boulderhalle geben zu k&#214nnen.Das wichtigste zuerst: Die Er&#214ffnung des Monkey Cage ist f&#220r November 2016 geplant und wir sind guter Dinge und sehr zuversichtlich, dass dies auch so bleibt.Bilder vom Bau und weitere Updates & Entwicklungen folgen.Au&#223erdem suchen wir noch tatkr&#228ftige Verst&#228rkung sowohl f&#220r unser Theken- als auch unser Trainerteam.Wenn Ihr also den Sport genauso liebt wie wir und Lust habt euch in einem Team rund um den Monkey Cage wieder zu finden, nehmt doch einfach mal Kontakt mit uns auf.
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="info-box info-box-4 info-box-white wow fadeIn">
										...
										<div class="info-box-info">
											<h4 class="info-box-title">SPASSZEITEN:</h4>
											<p class="info-box-text text-gray-2" style="text-align: justify;">
												Bouldern & Monkeybar:<br> T&#228glich 10:00 bis 23:00 Uhr <br> (auch an den meisten gesetzlichen Feiertagen, bei Abweichungen findet Ihr einen entsprechenden Hinweis hier in den &#132News&#147)
											</p>
										</div>
									</div>
									<!-- End info box-4 -->
								...
								<div class="col-md-12">
									...
									<div class="info-box info-box-4 info-box-white wow fadeIn" data-wow-delay="0.2s">
										...
										<div class="info-box-info">
											<h4 class="info-box-title">Kidsbouldern:</h4>
											<p class="info-box-text text-gray-2">
												Mo bis Fr 10:00 bis 18:00 Uhr<br> Sa & So 10:00 bis 16:00 Uhr										</p>
										</div>
									</div>
									<!-- End info box-4 -->
								</div> <!-- /.col -->
								...
								<div class="col-md-12">
									...
									<div class="info-box info-box-4 info-box-white wow fadeIn" data-wow-delay="0.4s">
										...
										<div class="info-box-info">
											<h4 class="info-box-title">Sauna (5 &#163 Aufpreis zum regul&#228ren Tageseintritt):</h4>
											<p class="info-box-text text-gray-2">
												Mo bis Fr 18:00 bis 23:00 Uhr <br>Sa & So 11:00 bis 21:00 Uhr
											</p>
										</div>
									</div>
									<!-- End info box-4 -->
									...
									<div class="portfolio-item">
										<a class="item-link inline-popup-trigger" >
											...
											<div class="item-info text-white">
												<h3 class="item-info-title">Regelm&#228&#223ige Kurse</h3>
												<p class="item-info-text">(je 1x w&#214chentliches Techniktraining mit aufsteigender Schwierigkeit)</p>
											</div>
										</a>
									</div>
									...
									<div class="portfolio-item">
										<a class="item-link inline-popup-trigger" >
											...
											<div class="item-info text-white">
												...
												<p class="item-info-text">(Technik f&#220r Einsteiger 2x monatlich; Krafttraining f&#220r Fortgeschrittene 2x monatlich)</p>
											</div>
										</a>
									</div>
...
<div class="col-lg-12 col-xs-12" style=" border-style: solid; padding: 20px 10px 20px 10px;color: white; " >

<p>Wir weisen darauf hin, dass Minderj&#228hrige unter 14 nur mit Begleitperson klettern durfen und eine ausgef&#252llte Best&#228tigung vorliegen muss.</p> 
<p>Minderj&#228hrige ab 14&nbspm&#252ssen bei Eintritt eine von den Erziehungsberechtigten ausgef&#252llte&nbspEinverst&#252ndniserkl&#228rung&nbspabgeben.</p>
				...
				<div class="container">
						...
						<div class="col-md-4" >
							...
							* Use class "heading-uppercase" to enable uppercase letters.
							-->
							<div class="heading heading-lg heading-hover">
							<h2 class="heading-title text-white">Kontaktiere uns</h2>
								...
								* Use class "hr-dotted", "hr-dashed" or "hr-double" to shange divider style.
								...
								<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d20525.453553890606!2d9.097298529046132!3d49.97982763243011!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNDnCsDU4JzQ3LjQiTiA5wrAwNic1My4zIkU!5e0!3m2!1sen!2sin!4v1471693048601" width="300" height="300" frameborder="0" style="border:1" allowfullscreen></iframe>
						...
						<div class="col-md-4">
							...
							* Use class "heading-uppercase" to enable uppercase letters.
							...
							<div class="heading heading-lg heading-hover">
								<div>
									<span class="heading-title-ghost"></span>
								<h2 class="heading-title text-white">&nbsp <br> &nbsp</h2>
								...
								* Use class "hr-dotted", "hr-dashed" or "hr-double" to shange divider style.
								...
								<div class="fb-page" data-href="https://www.facebook.com/MonkeyCage1" data-tabs="timeline" data-width="300" data-height="300" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/DezyneTechnologies" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/DezyneTechnologies">Dezyne Technologies Pvt Ltd</a></blockquote></div>
							...
							* Use class "heading-uppercase" to enable uppercase letters.
							...
							<div class="heading heading-lg heading-hover">
								...
								* Use class "hr-dotted", "hr-dashed" or "hr-double" to shange divider style.
								...
								<a class="twitter-timeline" data-width="300" data-height="300" data-theme="light" href="https://twitter.com/MonkeyCage2016">Tweets by DezyneTech</a> <script async src="//platform.twitter.com/widgets.js" charset="utf-8"></script>
						...
						<div class="col-md-12">
							...
							<form id="contact-form" class="margin-top-80 text-white wow fadeIn" data-wow-delay="0.3s">
								...
								<div class="row">
									<div class="col-lg-4">
										<div class="form-group">
											<input type="text" class="form-control" name="Name:" placeholder="Vorname" required="">
										</div>
									</div>
									<div class="col-lg-4">
										<div class="form-group">
											<input type="text" class="form-control" name="Subject:" placeholder="Nachname" required="">
										</div>
									</div>
									<div class="col-lg-4">
										<div class="form-group">
									...
									<div class="col-lg-4">
										<div class="form-group">
											<input type="text" class="form-control" name="Subject:" placeholder="Land" required="">
										</div>
									</div>
									<div class="col-lg-4">
										<div class="form-group">
											<input type="text" class="form-control" name="Subject:" placeholder="Telefonnummer" required="">
										</div>
									</div>
								</div>
								<div class="row">
								...
								<div class="row">
									...
									<div class="col-lg-4">
										<button type="submit" class="btn btn-primary btn-rounded btn-block btn-lg">Nachricht senden</button>
									</div>
									<div class="col-lg-4" >
									</div>
								</div>
