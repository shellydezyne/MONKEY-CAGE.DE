...
<h3 style=" font-family: 'Montserrat', sans-serif;  padding: 0px 0px 10px 0px; text-align: center; ">Bild hochladen 6</h3>
...
<?php
   ...
   // $insert_product = "INSERT INTO products (product_image ) VALUES ('$file_tmp')  ";
    ...
    $insert_product = "UPDATE main SET pic6= '$file_name' ";
