...
$run_query= mysqli_query($conn, $select_table);

$get_info = mysqli_fetch_array($run_query);
  			...
  			<div class="col-lg-6">
          	 ...
          	 <table class="table">
                ...
                <?php echo $contentp; ?>
                   ...
                   <br>
                   <input readonly type="text" name="countDisplaycs" size="3" maxlength="3" value="1000"> Characters Remaining</td>
...
<div class="col-lg-12">
  			<div class="col-lg-6">
          	 ...
          	 <tr>
                ...
                <td><textarea rows="4" cols="50"  name="co1" onKeyDown="textCounter2(this.form.co1,this.form.countDisplayco1);" onKeyUp="textCounter2(this.form.co1,this.form.countDisplayco1);"><?php echo $co1p; ?> </textarea>

                <br>
                 <input readonly type="text" name="countDisplayco1" size="3" maxlength="3" value="300"> Characters Remaining</td>
               ...
               <br>
                ...
                <td><textarea rows="4" cols="50"  name="co2" onKeyDown="textCounter2(this.form.co2,this.form.countDisplayco2);" onKeyUp="textCounter2(this.form.co2,this.form.countDisplayco2);"><?php echo $co2p; ?> </textarea>

                <br>
                 <input readonly type="text" name="countDisplayco2" size="3" maxlength="3" value="300"> Characters Remaining</td>
      ...
      <div class="col-lg-12">
  			<div class="col-lg-6">
               ...
               <br>
                ...
                <td><textarea rows="4" cols="50"  name="co3" onKeyDown="textCounter2(this.form.co3,this.form.countDisplayco3);" onKeyUp="textCounter2(this.form.co3,this.form.countDisplayco3);"><?php echo $co3p; ?> </textarea>

                <br>
                 <input readonly type="text" name="countDisplayco3" size="3" maxlength="3" value="300"> Characters Remaining</td>
               ...
               <br>
                ...
                <td><textarea rows="4" cols="50"  name="co4" onKeyDown="textCounter2(this.form.co4,this.form.countDisplayco4);" onKeyUp="textCounter2(this.form.co4,this.form.countDisplayco4);"><?php echo $co4p; ?> </textarea>

                <br>
                 <input readonly type="text" name="countDisplayco4" size="3" maxlength="3" value="300"> Characters Remaining</td>
